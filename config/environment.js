...
module.exports = function(environment) {
  ...
  if (environment === 'development') {
    ...
    ENV.github.appUrl = 'https://github.com/apps/code-corps-local/installations/new';
  ...
  if (environment === 'remote-development') {
    ...
    ENV.github.appUrl = 'https://github.com/apps/code-corps-remote-development/installations/new';
  ...
  if (environment === 'staging') {
    ...
    ENV.cloudinary.cloud = 'dlcthdxrt';
    ENV.cloudinary.uploadPreset = 'gp6mt4v3';
    ENV.github.appUrl = 'https://github.com/apps/code-corps-staging/installations/new';
  ...
  if (environment === 'production') {
    ...
    ENV.github.appUrl = 'https://github.com/apps/code-corps/installations/new';
