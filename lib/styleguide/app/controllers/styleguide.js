...
export default Ember.Controller.extend({
  componentList: [{
    ...
    groupName: 'donation',
    options: ['donation-card-item', 'donation-card-logo', 'donation-container', 'project-header']
  }, {
    groupName: 'donations',
    ...
    actions: {
      selectComponent(selected) {
        set(this, 'selectedComponent', selected);
        this.transitionToRoute(`styleguide.${selected}`);
      }
    }
});
