...
moduleForComponent('post-filter-dropdown', 'Integration | Component | post filter dropdown', {
  integration: true
});
...
test('it renders', function(assert) {
  this.render(hbs`{{post-filter-dropdown}}`);
...
test('it sends the hide action when clicking close', function(assert) {
  ...
  this.render(hbs`{{post-filter-dropdown hide="hide"}}`);
